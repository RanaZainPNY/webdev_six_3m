...
<body>
    ...
    <div class="right-side-cart-area">
        ...
        <div class="cart-content d-flex">
            ...
            <div class="cart-list">
                ...
                <div class="single-cart-item">
                    <a href="#" class="product-image">
                        <img src="{{ asset('essencemaster/img/product-img/product-3.jpg') }}" class="cart-thumb"
                            alt="">
                        <!-- Cart Item Desc -->
                        <div class="cart-item-desc">
                            <span class="product-remove"><i class="fa fa-close" aria-hidden="true"></i></span>
    ...
    {{-- <section class="welcome_area bg-img background-overlay"
        style="background-image: url({{ asset('essencemaster/img/bg-img/bg-1.jpg') }});">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single_catagory_area d-flex align-items-center justify-content-center bg-img"
                        style="background-image: url({{ asset('essencemaster/img/bg-img/bg-2.jpg') }});">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single_catagory_area d-flex align-items-center justify-content-center bg-img"
                        style="background-image: url({{ asset('essencemaster/img/bg-img/bg-3.jpg') }});">
                        <div class="catagory-content">
                            <a href="#">Shoes</a>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single_catagory_area d-flex align-items-center justify-content-center bg-img"
                        style="background-image: url({{asset('essencemaster/img/bg-img/bg-4.jpg')}});">
                        <div class="catagory-content">
                    ...
                    <div class="popular-products-slides owl-carousel">
                        ...
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                <img src="{{ asset('essencemaster/img/product-img/product-1.jpg') }}" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img"
                                    src="{{ asset('essencemaster/img/product-img/product-2.jpg') }}" alt="">
                                <!-- Favourite -->
                        ...
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="{{ asset('essencemaster/img/product-img/product-2.jpg') }}" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img"
                                    src="{{ asset('essencemaster/img/product-img/product-3.jpg') }}" alt="">
                                <!-- Favourite -->
                                <div class="product-favourite">
                                    <a href="#" class="favme fa fa-heart"></a>
                                </div>
                        ...
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="{{ asset('essencemaster/img/product-img/product-3.jpg') }}" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img"
                                    src="{{ asset('essencemaster/img/product-img/product-4.jpg') }}" alt="">
                        ...
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="{{ asset('essencemaster/img/product-img/product-4.jpg') }}" alt="">
                                <!-- Hover Thumb -->
