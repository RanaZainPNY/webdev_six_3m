            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="checkout_details_area mt-50 clearfix">
                        ...
                        <form id='order-form' action="{{ route('web-place-order') }}" method="post">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input name='contact' type="tel" class="form-control" id="phone_number"
                                        min="0" value="">
                                </div>
                ...
                <div class="col-12 col-md-6 col-lg-5 ml-lg-auto">
                    <div class="order-details-confirmation">
                        ...
                        <button type='submit' href="#" class="btn essence-btn">Place Order</button>
                    </form>
                    </div>
                </div>
            </div>
